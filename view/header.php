...
<head>
    ...
    <title>ViTech - Moblie Shop</title>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="../controller/index.php" class="navbar-brand"><img src="images/logo.png"></a>
				</div>
			      	  ...
			      	  <?php
			      	  	if (isset($_SESSION['adminh'])) {
			      	  		$username = strtoupper($_SESSION['adminh']);
			      	  	 	echo "<li><a href='?action=admin'><span class='glyphicon glyphicon-user'></span> Xin chào! $username</a></li>
