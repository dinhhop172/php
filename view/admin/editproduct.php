...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?action=home">Admin - Vitech</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search text-center">
                            <div class="input-group custom-search-form">
                                <img src="../controller/images/admin.png" class="img-circle" width="100px" height="100px">
                                <h4 class="text-info bg-info" style="padding:15px; width: 100%;">Tô Tấn Vĩ - Admin</h4>
                            </span>
                            </div>
                            <!-- /input-group -->
                        </li>
    ...
    <section id="page-wrapper">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="alert alert-warning" >Sửa sản phẩm</h3>
                </div>
                <?php
                    $v = new m_product();
                    ...
                    <form action="?action=editactive&id=<?php echo $_GET['id'] ?>" method="post">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="number" class="form-control" name="price" value="<?php echo $edit[2] ?>">
                        </div>
                      </div>
                      <div class="form-group" style="margin-left: 18px;">
                        <label for="inputAddress" class="col-form-label">Hình ảnh</label>
                        <img src="../controller/images/product/<?php echo $edit[3] ?>" width="250px" height="250px">
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="inputCity" class="col-form-label">Screen</label>
                          <input type="text" class="form-control" name="screen" value="<?php echo $edit[4] ?>">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="inputState" class="col-form-label">Camera</label>
                          <input type="text" class="form-control" name="camera" value="<?php echo $edit[5] ?>">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="inputZip" class="col-form-label">Pin</label>
                          <input type="text" class="form-control" name="pin" value="<?php echo $edit[6] ?>">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="inputZip" class="col-form-label">Hệ điều hành</label>
                          <input type="text" class="form-control" name="os" value="<?php echo $edit[7] ?>">
                        </div>
                      </div>
